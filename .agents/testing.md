...
- Run package coverage with `vp test --coverage --run`; use `vp run coverage:gate` from the workspace when changing gate configuration or shared runtime behavior.
