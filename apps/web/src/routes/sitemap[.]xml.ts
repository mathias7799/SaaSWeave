...
// TODO: Add routes you don't want included in the sitemap to this blacklist.
const ROUTE_BLACKLIST = [] as const satisfies ReadonlyArray<NavigateTo>;
void ROUTE_BLACKLIST;
...
function shouldIncludeInSitemap(route: { id: string; path: string }): boolean {
  return shouldIncludePathInSitemap(stripLocalePrefix(route.path));
}
