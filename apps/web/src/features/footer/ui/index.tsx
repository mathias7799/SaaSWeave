...
import { Image } from "@saasweave/ui/components/image";
...
const navLinks: FooterLink[] = [
  { label: () => m.footer__pricing(), to: "/pricing" },
  { label: () => m.footer__about(), to: "/about" },
  { label: () => m.footer__changelog(), to: "/changelog" },
...
const socialLinks: (FooterLink & { icon: React.ReactNode })[] = [
  ...
  {
    href: "https://github.com/tsu-moe/saasweave",
