 ...
 * @example
 * ```ts
 * import { LOG_SERVICES } from "@saasweave/logger/client";
 *
 ...
 * @example
 * ```ts
 * import { log } from "@saasweave/logger/client";
 *
 ...
 * @example
 * ```ts
 * import { setIdentity } from "@saasweave/logger/client";
 *
 ...
 * @example
 * ```ts
 * import { clearIdentity } from "@saasweave/logger/client";
 *
 * clearIdentity();
 * ```
 */
