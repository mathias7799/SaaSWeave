 ...
 * @example
 * ```ts
 * import { tanstackStartServerFnLoggerMiddleware } from "@saasweave/logger/server/tanstack-start/middleware";
 *
 ...
 * @example
 * ```ts
 * import { tanstackStartRequestLoggerMiddleware } from "@saasweave/logger/server/tanstack-start/middleware";
 *
 * export const startInstance = createStart(() => ({
